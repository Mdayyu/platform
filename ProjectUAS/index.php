	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>DAPATKAN PENAWARAN MENARIK KHUSUS HARI INI, GUNAKAN JASA KAMI SEKARANG!</p>
			</div>
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					echo '
					<li style="color:white">Halo, '.$_SESSION["name"].'
					<li><a href="admin">Kelola Jasa</a></li>
					<li><a href="logout.php">Keluar?</a></li>
					';
					};
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="cart.php">Pesanan Saya</a></li>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Kelompok 10, Yogyakarta.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:andre@email">andre@gmail.com</a></li>
